...
related-postmortem: chat-ui/docs/ops/postmortems/2026-05-12-browser-bundle-node-imports.md
---
...
- Issue reporters that write `docs/ops/findings/` JSONL files (`fs.appendFile`)
