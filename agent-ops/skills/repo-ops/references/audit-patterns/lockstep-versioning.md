...
2. **Add the gate to** `docs/ops/findings/INDEX.md` Graduations.
...
- See `docs/ops/postmortems/2026-05-02-corpus-caret-lock.md` — the postmortem that drove the gate's authoring.
