...
When a doc moves via `git mv` from one tree location to another (typically `docs/plans/X.md` → `docs/ops/archive/YYYY-Q/PLAN-X.md`), intra-repo links from other files break. **Each linking file has a _different_ relative-path depth** — sed alone can't fix them in one pass.
...
------------------------  ----------------------------------------------------------------
CHANGELOG.md (root)       ./docs/plans/X.md        → ./docs/ops/archive/YYYY-Q/PLAN-X.md
ROADMAP.md (root)         same
docs/conventions/Y.md     ../plans/X.md            → ../../docs/ops/archive/YYYY-Q/PLAN-X.md
docs/journal/YYYY/MM/Z.md ../../../plans/X.md      → ../../../../docs/ops/archive/YYYY-Q/PLAN-X.md
packages/<pkg>/CHANGELOG  ../../../docs/plans/X.md → ../../../docs/ops/archive/YYYY-Q/PLAN-X.md
```

5 files, 4 different relative-path patterns. A `sed -i 's|docs/plans/X|docs/ops/archive/Y/PLAN-X|g'` doesn't work — the prefix segments differ.
...
EDITS = [
    (ROOT / "CHANGELOG.md",
     "./docs/plans/X.md",
     "./docs/ops/archive/2026-Q2/PLAN-X.md"),
    (ROOT / "ROADMAP.md",
     "./docs/plans/X.md",
     "./docs/ops/archive/2026-Q2/PLAN-X.md"),
