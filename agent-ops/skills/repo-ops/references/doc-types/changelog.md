...
### Fixed
- Crash on empty `docs/ops/postmortems/` folder (#388).
...
1. **`CHANGELOG.md` exists at repo root.** Not in `docs/ops/`. Convention is root.
...
- **CHANGELOG inside `docs/ops/`** — convention is repo root; tools look there.
