...
`ARCHITECTURE.md` at repo root is the recommended location (matklad's pattern). Avoid `docs/ops/architecture/index.md` unless you have a folder full of related docs.
...
5. **AGENTS.md references ARCHITECTURE.md**, not just `docs/ops/`.
