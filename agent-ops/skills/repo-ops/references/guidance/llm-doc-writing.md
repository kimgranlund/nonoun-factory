...
If you have more than 200 lines of relevant content, push detail into linked subfolders (`ARCHITECTURE.md`, `docs/ops/adrs/`, `docs/ops/runbooks/`). The entry file should _navigate to_ depth, not _contain_ depth.
...
- **Delete TODOs, comments, work-in-progress notes.** Use `docs/ops/PLAN.md` instead.
...
- ADRs: `docs/ops/adrs/`
- Postmortems: `docs/ops/postmortems/`
